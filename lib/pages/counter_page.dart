...
class _CounterPageState extends State<CounterPage> {
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text('${data.name}', style: TextStyle(fontSize: 40)),
                ),
                Center(
                  child: Text('${data.count}', style: TextStyle(fontSize: 30)),
                ),
              ],
            ),
          ),
  ...
  Future _createDialog(BuildContext context, int sign) {
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              MaterialButton(
                child: Text("Ок"),
                onPressed: () {
                  context.read<CounterBloc>().add(ChangeValueEvent(
                      index, sign * int.parse(countController.text)));
                  Navigator.of(context).pop();
                },
              ),
            ],
